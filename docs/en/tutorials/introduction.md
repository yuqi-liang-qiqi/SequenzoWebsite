...
Guides explain method choices. API pages document exact functions. Use this page to start from your research goal, then move to the pages you need.
...
- [How to Read Sequence Plots](/en/tutorials/reading-sequence-plots)
...
- [Reporting Sequence Analysis](/en/tutorials/reporting-sequence-analysis) when you write up the results
...
| --- | --- | --- |
| Describe and visualize trajectories | [Basic Concepts](/en/tutorials/basic-concepts), [Timing, Duration, and Order](/en/tutorials/timing-duration-order), [Sequence Indicators and Statistics](/en/tutorials/sequence-indicators-and-statistics) | [How to Read Sequence Plots](/en/tutorials/reading-sequence-plots), [Visualization Gallery](/en/visualization/gallery), [Sequence Statistics](/en/statistics/introduction), [Sequence Characteristics Indicators](/en/sequence-characteristics-indicators/introduction) |
...
| Scale clustering to large datasets | [Large Data and Robustness](/en/big-data/introduction), [Check Uniqueness Rate](/en/big-data/check-uniqueness-rate) | [Understanding CLARA](/en/tutorials/understanding-clara), [CLARA](/en/big-data/clara), [Scaling Multidomain Workflows](/en/big-data/multidomain-clara) |
...
| Mine frequent event patterns | [Basic Concepts](/en/tutorials/basic-concepts) | [Event Pattern Mining](/en/event-sequences/introduction) |
| Model transition histories or spell survival | [Sequence History Analysis](/en/tutorials/sequence-history-analysis), [Sequence Analysis Multi-state Model](/en/tutorials/multi-state-model) | [Event History and Survival](/en/event-history-analysis/samm-emlt-and-survival) |
...
| Write up methods for a paper | [Reporting Sequence Analysis](/en/tutorials/reporting-sequence-analysis) | [Cluster Quality Indicators](/en/tutorials/cluster-quality-indicators), [How to Cite](/en/basics/how-to-cite) |

## Run Code

Use [Runnable Notebooks](/en/basics/view-tutorials-online) for full Colab examples. For a compact in-doc example, start with the [Quickstart](/en/basics/quickstart).
