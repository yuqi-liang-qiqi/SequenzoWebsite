...
| [`count_subsequence_occurrences`](./count-subsequence-occurrences) | `seqeapplysub` | Direct conceptual match for counting subsequence matches. |
...
| [`plot_event_parallel_coordinates`](./plot-event-parallel-coordinates) | `seqpcplot` / `plot.seqelist(curve_type="pc")` | Parallel-coordinate view of event sequencing. |
...
| [`plot_event_dynamics`](./plot-event-dynamics) | `seqedplot` | Plot survival-style or hazard-style event dynamics. |
| [`compute_event_transition_matrix`](./compute-event-transition-matrix) | `seqetm` | Closest transition-related counterpart in event-sequence workflows. |
